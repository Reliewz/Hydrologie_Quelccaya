#======================================================================
# Script name: 04_02_temporal_harmonization_meteo_hourly.R
# Goal(s): 
...
qc_logs[[length(qc_logs) + 1]] <- log_qc_decision(
  ...
  reason = paste("The temporal structure analysis identified a temporal resolution of 15 minutes for this data file.",
                 ...
                 "Correct amount of aggregated rows. Before 3736 after 935 with two hours only containing 2 measurements instead of the expected 4."
  ))
